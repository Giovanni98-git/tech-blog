        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-gray-400 leading-relaxed">
              ...
              perferendis officia voluptatibus voluptates nisi voluptatem? Animi
              dolorum dignissimos, quaerat alias consequatur aliquid, corporis
              totam unde molestiae magni, laboriosam incidunt provident!
            </p>
            <div className="mt-10">
              <Link
                href="/about"
