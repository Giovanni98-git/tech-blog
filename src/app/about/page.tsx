      ...
      <div className="px-4 sm:px-12">
        ...
        <div className="space-y-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <Image
              src="/images/about/jeremiah-2911.jpg"
              alt="about-image"
              width={600}
              height={600}
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                and web development. We focus on pratical concepts, clean code,
          ...
          <div className="text-center">
            <h2 className="txt-2xl font-semibold text-gray-200 mb-4">
              Built for Developers
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto leading-relaxed mb-8">
              Wether you&apos;re just starting out or refining your skills,
              TechBlog is designed to inspire better design, and better
              thinking.
            </p>
            <Link
              href="/articles"
